...
/*   Updated: 2021/03/03 22:25:15 by jgonfroy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int	NinjaTrap::set_energy(void)
{
	_energy = 120;
	return _energy;
}

unsigned int	NinjaTrap::set_max_energy(void)
{
	_max_energy = 120;
	return _max_energy;
...
unsigned int	NinjaTrap::set_melee(void)
{
	_melee = 60;
	return _melee;
}

void	NinjaTrap::set_name(std::string name)
{
	_name = name;
}
